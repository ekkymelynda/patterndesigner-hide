...
namespace PatternDesigner.FacadePattern
{
    public class FacadePattern : ICommand, IPlugin
    {
        ...
        {
            this.Name = "Facade Pattern";
        }

        public FacadePattern(ICanvas canvas): this()
        {
            this.canvas = canvas;
        }
        ...
        public void Execute()
        {
            ...
            string[] lines = System.IO.File.ReadAllLines(Application.StartupPath + "\\Plugin\\FacadePattern.txt");
        ...
        {
            return new FacadePattern(canvas);
        }
