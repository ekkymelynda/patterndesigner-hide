...
namespace PatternDesigner.MementoPattern
{
    public class MementoPattern : ICommand, IPlugin
    {
        ...
        {
            this.Name = "Memento Pattern";
        }

        public MementoPattern(ICanvas canvas): this()
        {
            this.canvas = canvas;
        }
        ...
        public void Execute()
        {
            ...
            string[] lines = System.IO.File.ReadAllLines(Application.StartupPath + "\\Plugin\\MementoPattern.txt");
        ...
        {
            return new MementoPattern(canvas);
        }
