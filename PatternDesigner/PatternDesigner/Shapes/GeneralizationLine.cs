...
{
    class GeneralizationLine : Edge, IPersistance
    {
        ...
        public void Serialize(string path)
        {
            ...
            file.Add(new XElement("relation",
                ...
                new XAttribute("tipe", "Generalization")));
                ...
                if (reader.Name.Equals("diagram"))
                {
                    while (reader.Read())
                    {
                        if (reader.Name.Equals("relation"))
                        {
                            ...
                            if (id != null && tipe.Equals("Generalization"))
                            {
                                ...
                                Console.WriteLine("Generalization : " + id);

                                GeneralizationLine tempLine = new GeneralizationLine(start, end);
