...
{
    public class AddCommandPattern : AddPattern
    {
        public AddCommandPattern(ICanvas canvas) : base(canvas)
        {
            setCanvas(canvas);
        }
        ...
        public override void Execute()
        {
            ...
            string[] lines = System.IO.File.ReadAllLines("../../PatternSource/CommandPattern.txt");
