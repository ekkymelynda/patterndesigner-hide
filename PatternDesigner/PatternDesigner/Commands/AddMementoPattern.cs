...
{
    public class AddMementoPattern : AddPattern
    {
        public AddMementoPattern(ICanvas canvas) : base(canvas)
        {
            setCanvas(canvas);
        }
        ...
        public override void Execute()
        {
            ...
            string[] lines = System.IO.File.ReadAllLines("../../PatternSource/MementoPattern.txt");
