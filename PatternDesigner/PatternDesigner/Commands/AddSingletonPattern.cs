...
{
    public class AddSingletonPattern : AddPattern
    {
        public AddSingletonPattern(ICanvas canvas) : base(canvas)
        {
            setCanvas(canvas);
        }
        ...
        public override void Execute()
        {
            ...
            string[] lines = System.IO.File.ReadAllLines("../../PatternSource/SingletonPattern.txt");
