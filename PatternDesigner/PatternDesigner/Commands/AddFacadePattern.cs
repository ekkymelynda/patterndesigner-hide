...
{
    public class AddFacadePattern : AddPattern
    {
        public AddFacadePattern(ICanvas canvas) : base(canvas)
        {
            setCanvas(canvas);
        }
        ...
        public override void Execute()
        {
            ...
            string[] lines = System.IO.File.ReadAllLines("../../PatternSource/FacadePattern.txt");
