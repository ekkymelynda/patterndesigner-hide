...
namespace PatternDesigner.CompositePattern
{
    public class CompositePattern : ICommand, IPlugin
    {
        ...
        public CompositePattern(ICanvas canvas): this()
        {
            this.canvas = canvas;
        }
        ...
        public void Execute()
        {
            ...
            string[] lines = System.IO.File.ReadAllLines(Application.StartupPath + "\\Plugin\\CompositePattern.txt");
        ...
        {
            return new CompositePattern(canvas);
        }
