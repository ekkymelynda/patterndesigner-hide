...
namespace PatternDesigner.FactoryPattern
{
    public class FactoryPattern : ICommand, IPlugin
    {
        ...
        {
            this.Name = "Factory Pattern";
        }

        public FactoryPattern(ICanvas canvas): this()
        {
            this.canvas = canvas;
        }
        ...
        public void Execute()
        {
            ...
            string[] lines = System.IO.File.ReadAllLines(Application.StartupPath + "\\Plugin\\FactoryPattern.txt");
        ...
        {
            return new FactoryPattern(canvas);
        }
